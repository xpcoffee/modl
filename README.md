...
Runnable: model, commands, trace and replay, all three paradigms, groups with collapse and expand, filtering, hiding, selection highlight, pan-to-relation, the canvas, the inspector, and save/load. 253 unit tests and 140 browser tests.
