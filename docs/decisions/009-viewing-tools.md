...
**Status**: accepted · **Date**: 2026-08-04 · **Revised**: 2026-08-05 after review on PR #16, again for issue #18 (group selection highlights members), and again for issue #33, which removed the filter bar these controls used to live on. See [decision 015](015-search-and-filter-menu.md)
